...
# Obtendo as medidas dos lados do triângulo do usuário
...
# Criando um objeto triangulo1 da classe Triangulo com as medidas fornecidas pelo usuário
...
# Obtendo e exibindo o maior lado do triângulo
