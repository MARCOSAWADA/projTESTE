...
# Criando um objeto agenda1 da classe Agenda para o dia 27 de junho de 2024
agenda1 = Agenda(27, 6, 2024)

# Verificando se a data é válida usando o método estático
